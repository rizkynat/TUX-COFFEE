                  ...
                  <div class="main" style="margin: 10px 10px;background-color: white;">
                    <div class="container-fluid">
                      <div class="row py-2 text-center">
                        <div class="col-3">
                          <h4 style="color: #C0A06F;">Daftar Akun Admin</h4>
                        </div>
                        <div class="col-9">
                      ...
                      <div class="row py-2">
                        <div class="col-12">
                             ...
                             <%
    ResultSet rs = controllers.ConnectionProvider.getResultFromSqlQuery("select * from admin");
%>                                         <!--Table-->
<!--Table-->
<table class="table table-hover table-fixed table-bordered">
  ...
  <tbody>
    <tr>
      <td><img src="asset/wanita 1.png" alt="" width="50px"></td>
      <td><%=rs.getString("username_adm")%></td>
      <td><%=rs.getString("email_adm")%></td>
      <td><%=rs.getString("nama_lengkap_adm")%></td>
      <td><%=rs.getString("password_adm")%></td>
      <td><%=rs.getString("role")%></td>
      <td>
        <div class="row text-center"><div class="col-6">
          <a href="http://localhost:8080/tux_coffee/pages/hapusAdmin.jsp?id_admin=<%=rs.getInt("id_admin")%>">
      ...
      <div class="col-6">
        <a href="http://localhost:8080/tux_coffee/pages/registerAdmin.jsp">
