              ...
              <div class="row g-0">
                <div class="col-lg-6">
                  <div class="card-body p-md-5 mx-md-4">
                    ...
                    <div class="text">
                      <h2 class="mt-1 mb-5 pb-1 " style="color: #C0A06F;">Masuk sebagai Admin</h2>
                    </div>
    
                      <form method="post" action="http://localhost:8080/tux_coffee/pages/loginAdminProcess.jsp">
                   
    
                      <div class="form-outline mb-4" style="color:#C0A06F;">
                        <label class="form-label" for="form2Example11">Masukkan email Admin</label>
                        <input type="email" id="form2Example11" class="form-control" name="email_adm" placeholder="name@example.com"/>
                        
                      </div>
    
                      <div class="form-outline mb-4" style="color:#C0A06F;">
                        <label class="form-label" for="form2Example22">Kata sandi</label>
                        <input type="password" id="form2Example22" class="form-control" name="password_adm" placeholder="Minimal 8 karakter"/>
                      ...
                      <div class="d-flex align-items-center justify-content-center pb-4">
                        ...
                        <a href="http://localhost:8080/tux_coffee/pages/registerAdmin.jsp" style="color: #C0A06F; text-decoration: none;">Daftar sekarang</a></p>
                      </div>
