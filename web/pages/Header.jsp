    ...
    <div class="container-fluid py-5">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid justify-content-between" >
          ...
          <div class="col-7" >
          <a href="http://localhost:8080/tux_coffee/pages/Home.jsp" class="navbar-brand" hreflang="#">
          ...
          <div class="col-1 offset-1">
            <span>
                <a href="http://localhost:8080/tux_coffee/pages/notifikasi.jsp">
          ...
          <div class="col-1 ">
            <span>
                <a href="http://localhost:8080/tux_coffee/pages/profileUser.jsp">
