                  ...
                  <div class="main" style="margin: 10px 10px;background-color: white;">
                    <div class="container-fluid">
                      <div class="row py-2 text-center">
                        <div class="col-3">
                          <h4 style="color: #C0A06F;">Daftar Akun User</h4>
                        </div>
                        <div class="col-9">
                      ...
                      <div class="row py-2">
                        <div class="col-12">
                               <%
    ResultSet rs = controllers.ConnectionProvider.getResultFromSqlQuery("select * from pelanggan");
%>                                           <!--Table-->
<table class="table table-hover table-fixed table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><%=rs.getString("username_pel")%></td>
      <td><%=rs.getString("email_pel")%></td>
      <td><%=rs.getString("nama_lengkap_pel")%></td>
      <td><%=rs.getString("no_hp")%></td>
      <td><%=rs.getString("password")%></td>
      <td>
        <div class="row text-center"><div class="col-6">
                <a href="http://localhost:8080/tux_coffee/pages/hapusPelanggan.jsp?id_pelanggan=<%=rs.getString("id_pelanggan")%>">
      ...
      <div class="col-6">
        <a href="http://localhost:8080/tux_coffee/pages/register.jsp">
